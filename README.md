...
## About
This [repository](https://github.com/rboxeur/linuxgaming-fix-vcrun2022-install) provides to install Visual C++ 2015-2055.
...
```bash
git clone https://github.com/rboxeur/linuxgaming-fix-vcrun2022-install.git
```
...
```bash
cp -af x64/dlls/* /path/to/windows/system32/
